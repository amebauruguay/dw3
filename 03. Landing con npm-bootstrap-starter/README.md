# Basado en Bootstrap npm starter template
...
You can [download the zip file](https://github.com/twbs/bootstrap-npm-starter/archive/main.zip) or clone the repository with the following command.
